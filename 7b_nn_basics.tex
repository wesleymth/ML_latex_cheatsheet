...
$
\begin{aligned}
\int_{|x| \leq r}\left|\color{red}{f(x)}\color{black}-\color{blue}{f_{n}(x)}\color{black}\right| d x & =\int_{|x| \leq r}\left(\color{red}f(x)\color{black}-\color{blue}f_{n}(x)\color{black}\right) d x \\
