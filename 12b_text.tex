...
% - Needs def. of Context e.g. document, paragraph, sentence, window and Vocabulary $\mathcal{V}:=\left\{w_{1}, \ldots, w_{D}\right\}$
...
%  Same inner product score $=$ matrix factorization.
...
- $f$ is a linear classifier loss function, $y_{n} \in\{ \pm 1\}$ is the classification label for sentence $\mathbf{x}_{n}$.
