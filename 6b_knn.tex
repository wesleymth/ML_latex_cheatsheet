...
%   \item High computational complexity for large $N$ 
%   % (but efficient data structure may exist)
% \end{itemize}
...
\section{KNN Curse of dimensionality}
...
% \subsubsection*{\underline{Proof} (I)}
% - We want to bound:
...
% \subsubsection*{\underline{Proof} (II)}
...
% \subsubsection*{\underline{Proof} (III)}
% \begin{itemize}
%   \item General case:
% \end{itemize}
...
% \subsubsection*{\underline{Proof} (IV)}
% \scalebox{0.6}{
% $
% \begin{aligned}
...
% \underline{Proof}: Consider the worst case: 
