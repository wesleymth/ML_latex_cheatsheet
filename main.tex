...
\usepackage{scrextend} % To change the fontsize
\changefontsizes{4pt}
...
\sectionnewcolor
\input{3d_regularization.tex}
\sectiondivider

\sectionnewcolor
\input{4a_model_selection.tex}
\sectiondivider

\sectionnewcolor
\input{4b_bias_variance.tex}
\sectiondivider

\sectionnewcolor
\input{5a_classification.tex}
\sectiondivider

\sectionnewcolor
\input{5b_logistic_regression.tex}
\sectiondivider
...
\sectionnewcolor
\input{7a_kernel_regression.tex}
\sectiondivider

\sectionnewcolor
\input{7b_nn_basics.tex}
\sectiondivider

\sectionnewcolor
\input{8a_nn_training.tex}
\sectiondivider

\sectionnewcolor
\input{8b_nn_advanced.tex}
\sectiondivider
...
\sectionnewcolor
\input{10a_ethics_fairness.tex}
\sectiondivider

% \sectionnewcolor
% \input{10b_unsupervised.tex}
% \sectiondivider

\sectionnewcolor
\input{10c_kmeans.tex}
\sectiondivider
...
\sectionnewcolor
\input{13a_self_supervised.tex}
\sectiondivider


\sectionnewcolor
\input{13b_generative_models.tex}
\sectiondivider
